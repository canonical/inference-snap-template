...
SNAP_NAME ?= {snap-name} # Replace with snap name
ENGINE ?= cpu

.PHONY: all help init init-submodules install-deps download-models download-model-7b
...
download-models: download-model-7b

download-model-7b: # Update to match the expected model
	$(hf) download {...} \
		--local-dir components/model-7b-q4-k-m-gguf/
